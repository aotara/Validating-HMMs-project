...
# read data with observed and decoded state result obtained from HMMs deemed optimal
cockleArcticIN<- read.csv('Figs6-7-8/Fig6Data/Cockle-arctic-IN-M5-result.csv') 
cockleSandwichIN<- read.csv('Figs6-7-8/Fig6Data/Cockle-sandwich-IN-M6-result.csv') 
bluecircleRoseateIN<- read.csv('Figs6-7-8-/Fig6Data/BlueCircle-roseate-IN-M4-result.csv') 
islemayArcticIN<- read.csv('Figs6-7-8/Fig6Data/IsleMay-arctic-IN-M6-result.csv') 
leithCommonIN<- read.csv('Figs6-7-8/Fig6Data/Leith-common-IN-M0-result.csv') 
...
# read data with observed and decoded state result obtained from HMMs deemed optimal
cemlynCommonCR<-read.csv('Figs6-7-8/Fig7Data/Cemlyn-common-CR-M6-result.csv')
cemlynArcticCR<-read.csv('Figs6-7-8/Fig7Data/Cemlyn-arctic-CR-M4-result.csv')
cockleSandwichCR<-read.csv('Figs6-7-8/Fig7Data/Cockle-sandwich-CR-M6-result.csv')
coquetArcticCR<-read.csv('Figs6-7-8/Fig7Data/Coquet-arctic-CR-M1-result.csv')
coquetCommonCR<-read.csv('Figs6-7-8/Fig7Data/Coquet-common-CR-M0-result.csv')
coquetRoseateCR<-read.csv('Figs6-7-8/Fig7Data/Coquet-roseate-CR-M4-result.csv')
coquetSandwichCR<-read.csv('Figs6-7-8/Fig7Data/Coquet-sandwich-CR-M3-result.csv')
glaseileananCommonCR<-read.csv('Figs6-7-8/Fig7Data/GlasEileanan-common-CR-M0-result.csv')
leithCommonCR<-read.csv('Figs6-7-8/Fig7Data/Leith-common-CR-M2-result.csv')
southshianCommonCR<-read.csv('Figs6-7-8/Fig7Data/SouthShian-common-CR-M4-result.csv')
islemayArcticCR<-read.csv('Figs6-7-8/Fig7Data/IsleMay-arctic-CR-M1-result.csv')
bluecircleSandwichCR<-read.csv('Figs6-7-8/Fig7Data/BlueCircle-sandwich-CR-M2-result.csv')
forvieSandwichCR<-read.csv('Figs6-7-8/Fig7Data/Forvie-sandwich-CR-M3-result.csv')
...
### STEP 3 : PLOT FIGURE 7 on page 18
...
### STEP 2 : PLOT FIGURE 8 on page 19
