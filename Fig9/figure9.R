...
setwd(" ")
################################################################################
# Figure 9 (a) and (b) Page 19
# Visual tracks from South Shian Colony coloured by observed & decoded states
################################################################################
data<-read.csv('Fig9/SouthShian_Common-CR-M4result.csv')  #read data
...
plot(data,'Observed states') #Figure 9a Page 19
plot(data,'Decoded states') #Figure 9b Page 19
